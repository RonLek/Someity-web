...
const Index = () => {
  ...
  if (isVisiblel1) {
    refl1.current.className = 'lg:pr-32 xl:pr-48 animation-element slide-left in-view';
  }
  ...
  if (isVisiblel2) {
    refl2.current.className = 'lg:pr-32 xl:pr-48 animation-element slide-left in-view';
  }
  ...
  if (isVisiblel3) {
    refl3.current.className = 'lg:pr-32 xl:pr-48 animation-element slide-left in-view';
  }
  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-8 lg:flex">
          <div className="text-center lg:text-left lg:w-1/2">
            ...
            <div className="mt-4 ml-2 text-gray-600 flex flex-row items-center">
              Available on: <SiGooglechrome className="mx-4 " title="Google Chrome" />{' '}
      ...
      <SplitSection
        id="services"
        primarySlot={
          <div ref={refl1} className="lg:pr-32 xl:pr-48 animation-element slide-left">
      ...
      <SplitSection
        reverseOrder
        primarySlot={
          <div ref={refl2} className="lg:pl-32 xl:pl-48 animation-element slide-right">
      ...
      <SplitSection
        primarySlot={
          <div ref={refl3} className="lg:pr-32 xl:pr-48 animation-element slide-left">
            <h3 className="text-3xl font-semibold leading-tight">
